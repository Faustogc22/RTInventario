              ...
              <div class="col-md-12">
                  <div class="box">
                    ...
                    <div class="panel-body">
		                ...
		                <h4>Desarrollado por: </h4> <p>klebergc22@hotmail.com</p>
		                <h4>Web: </h4><a href="" target="_blank"> <p>www.tecknasoft.com</p></a>
		                <!--<h4>Cursos: </h4> <a href="https://www.udemy.com/user/juan-carlos-arcila-diaz/" target="_blank"><p>Mis cursos en Udemy.</p></a>-->
		                <h4>Canal Youtube: </h4> <a href="" target="_blank"><p>www.micanal.com</p></a>
                    </div>
                    <!--Fin centro -->
                  </div><!-- /.box -->
              </div><!-- /.col -->
